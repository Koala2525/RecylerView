...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] data = new String[] {
        "这是一段短的测试文字，在屏幕上最多展示为两行，再加一段后缀文字。", "百度百科是百度公司2006年4月20日发布的开放式网络百科全书，2008年4月21日推出正式版，"
        + "截止到2018年10月其条目总量已超过1,559万。 百度官方表示，百度百科在创建一部网络百科全书的同时，"
        + "亦作为百度为网友提供的信息存储空间。百度百科在精神上主张“平等、协作、分享、自由”。", "这段文字没有意义" + "aaacccdddbbb"
    };

    @Override protected void onCreate(@Nullable Bundle saveInstanceState) {
    ...
    public void initlithoitem() {
        for (int i = 0; i < 5; ++i) {
            lithoitem item_1 =
                new lithoitem("大圣", "1572870645724", R.drawable.multi_image_1, R.drawable.icon_test,
                    data[0], R.drawable.image_test_1, 800, 1066);
            ...
            lithoitem item_3 =
                new lithoitem("哪吒", "1572870645726", R.drawable.multi_image_3, R.drawable.icon_test,
                    data[2], R.drawable.image_test_3, 700, 934);
